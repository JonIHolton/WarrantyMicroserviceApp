...
hostname = os.getenv('rabbit_host', 'localhost')  # Default to localhost if not provided
port = os.getenv('rabbit_port', '5672')       # Default RabbitMQ port

# Use rabbit_host and rabbit_port to connect to RabbitMQ
